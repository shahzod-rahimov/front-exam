...
function createCars(arr) {
  ...
  arr.forEach((obj) => {
    const context = `
              ...
              <p class="subtitle-white font-medium text-[#555] mt-2 ">${obj.subtitle}</p>
              <img
                src=${obj.img}
                alt=${obj.title}
                class="mt-4"
              ...
              <div class="flex gap-[68px]">
                ...
                <svg id="position" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="flex items-center gap-[51px]">
                <div class="flex gap-[15px]">
                  ...
                  <svg id="user-file" width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
